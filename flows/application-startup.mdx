...
description: "Step-by-step trace of how an ABP application boots: factory, module loader, module manager, and the lifecycle contributor chain that calls every module."
---
