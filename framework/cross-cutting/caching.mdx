---
title: "Distributed caching, hybrid cache, and tenant key normalisation"
...
`DistributedCacheKeyNormalizer` (`DistributedCacheKeyNormalizer.cs`) is the singleton invoked for every key:
...
| `Volo/Abp/Caching/IDistributedCache.cs` | Single- and two-generic interfaces, plus `IDistributedCache` re-export. |
