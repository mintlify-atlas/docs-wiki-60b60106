...
| `FullAuditedAggregateRootWithUser<TUser>` | – | `Creator`, `LastModifier`, `Deleter` (nav) | `FullAuditedAggregateRoot` | `Entities/Auditing/FullAuditedAggregateRootWithUser.cs` |
