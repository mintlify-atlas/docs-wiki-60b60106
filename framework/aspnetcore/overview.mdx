...
description: "How AbpAspNetCoreModule wires an ABP application into an ASP.NET Core host: WebApplicationBuilder bridging, ObjectAccessor wiring, and InitializeApplication."
---
