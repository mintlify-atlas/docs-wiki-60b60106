...
description: "How ABP composes modules, the bootstrap pipeline, the canonical layered solution and the cross-cutting interceptor pipeline."
---
...
Other notable interceptors registered the same way: feature checking (`FeatureCheckerInterceptor`), global feature checking, entity history (`EntityChangeTrackingInterceptor`), and tenant-side enforcement (`MultiTenancySideInterceptor`).
...
graph LR
    ...
    Auth --> Feat[FeatureCheckerInterceptor]
